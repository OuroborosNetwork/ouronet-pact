...
(module AQPGAS GOVERNANCE
    ...
    (defun XI_MeasureStakeTf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_StakeTrueFungible patron pool-id owner owner ouro-id amount)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureUnstakeTf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_UnstakeTrueFungible patron pool-id owner owner ouro-id amount)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureStakeOf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_StakeOrtoFungible patron pool-id owner owner dpof-id nonces)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureUnstakeOf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_UnstakeOrtoFungible patron pool-id owner owner dpof-id nonces)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureStakeDpsf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_StakeSemiFungibleCollectable patron pool-id owner owner dpsf-id nonces)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureUnstakeDpsf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_UnstakeSemiFungibleCollectable patron pool-id owner owner dpsf-id nonces)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureStakeDpnf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_StakeNonFungibleCollectable patron pool-id owner owner dpnf-id nonces)
            (- (env-gas) g-before)
        )
    )
    (defun XI_MeasureUnstakeDpnf:integer
        ...
        (let
            ...
            (ref-TS02-C3::AQP-POOL|C_UnstakeNonFungibleCollectable patron pool-id owner owner dpnf-id nonces)
            (- (env-gas) g-before)
        )
    )
)
