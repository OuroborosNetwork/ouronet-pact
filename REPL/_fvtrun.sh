...
python3 REPL/tools/_fvtgen.py    | tail -1
python3 REPL/tools/_fvtasm.py    | grep -E 'wrote 04_RPS|MISSING'
python3 REPL/tools/_fvtflip.py   | grep -E 'CUT|residual|new FVT'
python3 REPL/tools/_fvtfacade.py | tail -1
