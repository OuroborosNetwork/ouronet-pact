;; GENERATED FILE -- DO NOT EDIT. Regenerate with: cd REPL && python3 _stagez_variant.py
;;
;; REPL-ONLY TESTING VARIANT of 2_CITIZEN/Stage_Z/02_EXPLORER.pact
...
;;   - module renamed EXPLORER -> EXPLORER-TESTING (so it deploys ALONGSIDE canonical, never shadowing it)
;;   - "Auryndex-O136CBn22ncY" -> "Auryndex-98c486052a51"
;;   - "EliteAuryndex-O136CBn22ncY" -> "EliteAuryndex-98c486052a51"
    ...
    (defun URC_0001_LandingPage ()
        ...
        (let
            (
                ...
                (EAuryndex:string "EliteAuryndex-98c486052a51")
