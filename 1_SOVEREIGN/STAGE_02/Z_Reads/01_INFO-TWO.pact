...
(module INFO-TWO GOV
    ...
    (defun URC_DPNF|WipeHeavy:object{OuronetInfoV1.ClientInfo} (patron:string account:string id:string) (let ((r:module{DpdcManagementV1} DPDC-MNG)) (URC_DPDC-MNG|WipeMulti patron id false (r::URHC_WipePure account id false) "Heavy")))
    (defun URC_DPSF|WipeHeavy:object{OuronetInfoV1.ClientInfo} (patron:string account:string id:string) (let ((r:module{DpdcManagementV1} DPDC-MNG)) (URC_DPDC-MNG|WipeMulti patron id true (r::URHC_WipePure account id true) "Heavy")))
