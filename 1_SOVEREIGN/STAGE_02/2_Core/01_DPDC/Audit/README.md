...
| H4c | HIGH | DPDC-N | *(new, found verifying H4b)* `meta-data.composition` (NFT-Set constituent record) can be overwritten to arbitrary values via `C_UpdateNonces`, decoupled from real escrow contents | OPEN — owner verdict pending |
