...
| **I — Owner feedback** | `ROUND-01-OWNER-FEEDBACK.md` | Owner's verdict per finding + new StoicSyntax rules. Living — C10, C13, C12, C5, H9 refuted; C11, H10, H7, H8, M10 design; C2, C1, C7, C8, C9, H12, H11, H6, C6, H4, H2, C4, H5, H3, H1, M9, M13, C3(stable) fixed, C3(weighted) accepted limitation; rest still pending. |
...
| M1–M8, M11, M12, M14 | MED | various | See `ROUND-01-FINDINGS.md` § MEDIUM | mixed | _pending_ |
