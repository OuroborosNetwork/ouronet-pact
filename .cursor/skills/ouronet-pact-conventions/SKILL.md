...
description: Ouronet Pact conventions index. Canonical doc in repo — read OuronetInformational.
---

# ouronet-pact-conventions
...
Do not rely on this stub alone — the canonical rules live in **`OuronetInformational/`** in the git repo.
