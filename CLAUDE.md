...
| `REPL/` | Staged loaders and scenario files. **All 44 analysis scripts live in `REPL/tools/`** (moved there 2026-09-14) — index in `REPL/TOOLS.md`, generated by `tools/_toolindex.py`. The gate is `python3 REPL/tools/_gate.py`; it resolves its own paths, so it runs from any directory. |
