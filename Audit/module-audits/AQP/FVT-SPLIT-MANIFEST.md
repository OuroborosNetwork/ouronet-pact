...
Generated by static call-graph analysis (`REPL/tools/_fvtsplit.py`) over `04_FVT.pact`.
...
(Full name list: `REPL/tools/_fvtsplit.py list`.)
...
The flip is fully scripted (`REPL/tools/_fvtflip.py`) and driven ~90% to green in a dry run; restored
