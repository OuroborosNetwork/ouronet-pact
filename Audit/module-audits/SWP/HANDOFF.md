...
Continuing a Round-I "Owner Feedback" pass over `Audit/module-audits/SWP/ROUND-01-FINDINGS.md`
...
Audit/module-audits/SWP/ISSUES-RANKED.md   (annotations through #20H)
Audit/module-audits/SWP/README.md          (tracker + HARD RULE)
Audit/module-audits/SWP/ROUND-01-OWNER-FEEDBACK.md (entries through #20H)
Audit/module-audits/SWP/ROUND-02-FIXES.md  (Fix #1 through Fix #10)
...
Audit/module-audits/ATS/*.md  (all of them)
