...
**Version 2.0** · built 2026-09-20 · commit `82e7d4a+dirty` · generated by `REPL/tools/_auditbook.py`
...
| `.repl` lines | 68,435 | 120,603 | **138,663** |
| distinct assertions written | **1,604** | **5,262** | **5,902** |
...
> **5,902**, measured when this book was built. The canonical value is whatever `ARCHITECTURE/REPL_SUITE_STATS.md`
...
| **1.5** REPL finalisation | a one-command gate over the whole suite | **92** gate entrypoints, **14** fatal static checks, **5,902** distinct assertions, orphaned asserting files **0** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **208** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **138,663** |
| distinct assertions | **1,604** | 1,663 | 2,431 | **5,262** | 5,555 | **5,902** |
...
<sub>The 5,804 here excludes `archive/`; §1's 5,902 is the project's own `_suite_stats.py` rule, which
...
| distinct assertions the stats file publishes now (`fb58cba`, 2026-09-18) | **5,902** |
| distinct assertions counted from the tree now | **5,902** |
