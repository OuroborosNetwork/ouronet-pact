...
**Version 1.0** · built 2026-09-19 · generated by `REPL/tools/_auditbook.py`
...
> The suite's 25,140 executed assertions — measured at build time; this book
...
At the time of writing, the full gate is **green at 25,140 assertions** (20,148 positive, 4,992
...
> **That number is a snapshot and will move.** It rose from 22,939 to 25,140 during the round
...
`25,140` or `415`, and the assembler substitutes the number it
