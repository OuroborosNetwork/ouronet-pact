...
**Version 2.0** · built 2026-09-21 · commit `73eac5e+dirty` · generated by `REPL/tools/_auditbook.py`
...
| Pact source lines | 96,310 | 114,156 | **118,894** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **208** |
| `.repl` lines | 68,435 | 120,603 | **139,000** |
| distinct assertions written | **1,604** | **5,262** | **5,923** |
...
> **5,923**, measured when this book was built. The canonical value is whatever `ARCHITECTURE/REPL_SUITE_STATS.md`
...
| **1.5** REPL finalisation | a one-command gate over the whole suite | **92** gate entrypoints, **14** fatal static checks, **5,923** distinct assertions, orphaned asserting files **0** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **208** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **139,000** |
| distinct assertions | **1,604** | 1,663 | 2,431 | **5,262** | 5,555 | **5,923** |
...
<sub>The 5,804 here excludes `archive/`; §1's 5,923 is the project's own `_suite_stats.py` rule, which
...
| distinct assertions the stats file publishes now (`fb58cba`, 2026-09-18) | **5,923** |
| distinct assertions counted from the tree now | **5,923** |
...
> The suite's 25,629 executed assertions — measured at build time; this book
...
At the time of writing, the full gate is **green at 25,629 assertions** (20,532 positive, 5,097
...
> **That number is a snapshot and will move.** It rose from 22,939 to 25,629 during the round
...
`25,629` or `415`, and the assembler substitutes the number it
