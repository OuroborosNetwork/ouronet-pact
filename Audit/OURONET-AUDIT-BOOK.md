...
**Version 3.0** · built 2026-09-24 · commit `95163d5e+dirty` · generated by `REPL/tools/_auditbook.py`
...
|---|---:|---:|---:|
| Pact source files | 91 | 93 | **96** |
| Pact source lines | 96,310 | 114,156 | **121,920** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **209** |
| `.repl` lines | 68,435 | 120,603 | **139,965** |
| distinct assertions written | **1,604** | **5,262** | **5,990** |
...
> **5,990**, measured when this book was built. The canonical value is whatever `ARCHITECTURE/REPL_SUITE_STATS.md`
...
| **1.5** REPL finalisation | a one-command gate over the whole suite | **93** gate entrypoints, **14** fatal static checks, **5,990** distinct assertions, orphaned asserting files **0** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **209** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **139,965** |
| distinct assertions | **1,604** | 1,663 | 2,431 | **5,262** | 5,555 | **5,990** |
...
<sub>The 5,804 here excludes `archive/`; §1's 5,990 is the project's own `_suite_stats.py` rule, which
...
| distinct assertions the stats file publishes now (`fb58cba`, 2026-09-18) | **5,990** |
| distinct assertions counted from the tree now | **5,990** |
...
> The suite's 25,991 executed assertions — measured at build time; this book
...
At the time of writing, the full gate is **green at 25,991 assertions** (20,831 positive, 5,160
...
> **That number is a snapshot and will move.** It rose from 22,939 to 25,991 during the round
...
`25,991` or `415`, and the assembler substitutes the number it
...
| assertions executed per full gate run | 25,234 | **25,991** |
| distinct assertions written | 5,903 | **5,990** |
