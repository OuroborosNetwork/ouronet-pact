...
**Version 3.0** · built 2026-09-24 · commit `9693b516+dirty` · generated by `REPL/tools/_auditbook.py`
...
| Pact source lines | 96,310 | 114,156 | **123,033** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **209** |
| `.repl` lines | 68,435 | 120,603 | **140,218** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **209** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **140,218** |
