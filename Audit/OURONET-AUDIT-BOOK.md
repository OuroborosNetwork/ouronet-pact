...
**Version 3.0** · built 2026-09-24 · commit `791a3736+dirty` · generated by `REPL/tools/_auditbook.py`
...
| Pact source lines | 96,310 | 114,156 | **121,507** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **208** |
| `.repl` lines | 68,435 | 120,603 | **139,734** |
| distinct assertions written | **1,604** | **5,262** | **5,972** |
...
> **5,972**, measured when this book was built. The canonical value is whatever `ARCHITECTURE/REPL_SUITE_STATS.md`
...
| **1.5** REPL finalisation | a one-command gate over the whole suite | **92** gate entrypoints, **14** fatal static checks, **5,972** distinct assertions, orphaned asserting files **0** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **208** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **139,734** |
| distinct assertions | **1,604** | 1,663 | 2,431 | **5,262** | 5,555 | **5,972** |
...
<sub>The 5,804 here excludes `archive/`; §1's 5,972 is the project's own `_suite_stats.py` rule, which
...
| distinct assertions the stats file publishes now (`fb58cba`, 2026-09-18) | **5,972** |
| distinct assertions counted from the tree now | **5,972** |
...
| distinct assertions written | 5,903 | **5,972** |
