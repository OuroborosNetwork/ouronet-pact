...
**Version 1.1** · built 2026-09-20 · commit `ecf8913+dirty` · generated by `REPL/tools/_auditbook.py`
...
| Pact source lines | 96,310 | 114,156 | **116,401** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **207** |
| `.repl` lines | 68,435 | 120,603 | **138,362** |
| distinct assertions written | **1,604** | **5,262** | **5,894** |
...
> **5,894**, measured when this book was built. The canonical value is whatever `ARCHITECTURE/REPL_SUITE_STATS.md`
...
| **1.5** REPL finalisation | a one-command gate over the whole suite | **92** gate entrypoints, **14** fatal static checks, **5,894** distinct assertions, orphaned asserting files **0** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **207** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **138,362** |
| distinct assertions | **1,604** | 1,663 | 2,431 | **5,262** | 5,555 | **5,894** |
...
<sub>The 5,804 here excludes `archive/`; §1's 5,894 is the project's own `_suite_stats.py` rule, which
...
| distinct assertions the stats file publishes now (`fb58cba`, 2026-09-18) | **5,894** |
| distinct assertions counted from the tree now | **5,894** |
