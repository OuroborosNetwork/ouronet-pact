...
**Version 2.0** · built 2026-09-20 · commit `21fa54f+dirty` · generated by `REPL/tools/_auditbook.py`
...
| Pact source lines | 96,310 | 114,156 | **116,660** |
| `.repl` files (excl. `archive/`) | 181 | 209 | **208** |
| `.repl` lines | 68,435 | 120,603 | **138,682** |
...
|---|---:|---:|---:|---:|---:|---:|
| `.repl` files (excl. `archive/`) | 181 | — | — | 209 | — | **208** |
| `.repl` lines (excl. `archive/`) | 68,435 | — | — | 120,603 | — | **138,682** |
...
> The suite's 25,235 executed assertions — measured at build time; this book
...
At the time of writing, the full gate is **green at 25,235 assertions** (20,216 positive, 5,019
...
> **That number is a snapshot and will move.** It rose from 22,939 to 25,235 during the round
...
`25,235` or `415`, and the assembler substitutes the number it
