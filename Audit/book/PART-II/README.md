...
| 5 | `16_SWPI.pact` | slippage bound measured in **fee-less** tokens; a breach returned a string instead of reverting | **FIXED** — and re-attacked in the red team as `RT-H-002` ({{ch:register}}) |
...
the whole problem {{ch:method}} is about.
