...
| 10 | — | *init* — TX-02 [4.1.2] - Dalos INIT [02]: Define IMC Policies | — | `Deploy/2_Init/` · `REPL/Stage_01/[4.0]_Sovereign-Executor.repl:112` |
| 11 | **10** | DEPLOY 6 modules: 02_DPDC, 03_DPDC-C, 04_DPDC-I, 05_DPDC-R, 06_DPDC-MNG, 07_DPDC-T | 350,541 | `Deploy/1_Pure/10_deploy.pact` |
| 12 | **11** | DEPLOY 5 modules: 08_DPDC-S, 09_DPDC-F, 10_DPDC-N, 11_EQUITY+, 00_Demipad | 320,565 | `Deploy/1_Pure/11_deploy.pact` |
| 13 | **12** | DEPLOY 2 modules: 00_AQP-SCHEMAS, 01_ANK | 47,586 | `Deploy/1_Pure/12_deploy.pact` |
| 14 | **13** | DEPLOY 1 modules: 02_SCORE | 96,321 | `Deploy/1_Pure/13_deploy.pact` |
| 15 | **14** | DEPLOY 1 modules: 03_AQP | 151,366 | `Deploy/1_Pure/14_deploy.pact` |
| 16 | **15** | DEPLOY 1 modules: 04_RPS | 229,502 | `Deploy/1_Pure/15_deploy.pact` |
| 17 | **16** | DEPLOY 1 modules: 05_FVT | 203,548 | `Deploy/1_Pure/16_deploy.pact` |
| 18 | **17** | DEPLOY 3 modules: 06_VCT, 07_MTX-AQP, 08_DSA | 849,276 | `Deploy/1_Pure/17_deploy.pact` |
| 19 | **18** | DEPLOY 3 modules: 09_AQP-INFO, 01_TS02-C1, 02_TS02-C2 | 149,410 | `Deploy/1_Pure/18_deploy.pact` |
| 20 | **19** | DEPLOY 4 modules: 04_TS02-C3, 05_TS02-DPAD, 02_Snakes, 03_Custodians | 221,896 | `Deploy/1_Pure/19_deploy.pact` |
| 21 | — | *init* — TX-01 [4.1] - DPDC INIT [01]: Define IMC Policies | — | `Deploy/2_Init/` · `REPL/Stage_02/[4.0]_Sovereign-Executor.repl:49` |
| 22 | **20** | DEPLOY 2 modules: 01_INFO-TWO, 04_AQP-BOOT | 15,094 | `Deploy/1_Pure/20_deploy.pact` |
| 23 | — | *init* — deploy-stage02 · AQP-BOOT Step0 WireImcAndGovernor | — | `Deploy/2_Init/` · `REPL/deploy-stage02.repl:63` |
