...
2 init/config steps, in sequence order. **These are extracted, not generated.**
...
|---:|---:|---:|---|---|
| `01_init.pact` | 22 | 1 | deploy-stage02 · AQP-BOOT Step0 WireImcAndGovernor |  |
| `02_init.pact` | — | 4 | IMC POLICY DELTA (generated by _impdiff.py) |  |

**2 steps** · 0 flagged as possible fixtures · 0 carry no deployable forms (pure REPL scaffolding).
