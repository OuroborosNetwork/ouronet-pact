;; ---------------------------------------------------------------------------
;; OURONET DEPLOY -- file 12 of 19
;; This is STEP 12 of 20 in the full sequence (see Deploy/MANIFEST.md).
;; Steps 1-11 must have run first, including the init steps between deploys.
;; 1 module(s), 151,366 gas measured in the REPL gas model, 119,715 bytes
;;
