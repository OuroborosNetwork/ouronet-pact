...
This file ties **`OuronetInformational/ouronet/architecture/`** to **external-facing** docs.
...
|-------|------------------|
| Naming / prefixes | `OuronetInformational/ouronet/MODULE_ARCHITECTURE.md`, `0_Sample/.../ModuleSample.pact` |
