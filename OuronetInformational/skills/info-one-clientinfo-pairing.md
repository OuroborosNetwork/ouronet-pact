...
- `OuronetInformational/skills/x-writes-no-cumulator.md`, `MODULE_ARCHITECTURE.md` — `C_*` returns cumulators consumed by IGNIS; INFO never persists, only simulates prices.
- `.cursor/skills/ouronet-info-one-clientinfo/SKILL.md` — short pointer to this file.
