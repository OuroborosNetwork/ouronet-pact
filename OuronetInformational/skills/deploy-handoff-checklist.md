...
When a feature is **build-complete**, produce this document for the operator. Cursor skill: **`.cursor/skills/ouronet-deploy-handoff/SKILL.md`**.
...
Related: [`../ARCHITECTURE/DEPLOY_IMPACT_PATTERN.md`](../ARCHITECTURE/DEPLOY_IMPACT_PATTERN.md), [`../ARCHITECTURE/STAGE_01_CODEX_ON_CHAIN_DEPLOY.md`](../ARCHITECTURE/STAGE_01_CODEX_ON_CHAIN_DEPLOY.md), [`codex-stage01-repl.md`](codex-stage01-repl.md).
