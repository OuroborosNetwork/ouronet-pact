...
| | |
|---|---:|
| **distinct assertions written** | **5,439** |
| **assertions executed per full gate run** | **21,533** |
...
**Quote 5,439 for "how many tests exist" and 21,533 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 86 entrypoints, 21,533 assertions, 0 failures |
...
limit on what §2's 21,533 executed assertions certify: they establish that the system behaves as
