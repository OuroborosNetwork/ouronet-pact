...
|---|---|---|
| `REPL_SUITE_STATS.md` | every scale and coverage figure, plus all 5,484 per-function rows | **generated**: `cd REPL && python3 tools/_suite_stats.py --gate` |
...
| | |
|---|---:|
| **distinct assertions written** | **5,484** |
| **assertions executed per full gate run** | **21,888** |
...
**Quote 5,484 for "how many tests exist" and 21,888 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 88 entrypoints, 21,888 assertions, 0 failures |
...
limit on what §2's 21,888 executed assertions certify: they establish that the system behaves as
