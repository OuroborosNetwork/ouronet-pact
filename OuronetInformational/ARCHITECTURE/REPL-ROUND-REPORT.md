...
| | |
|---|---:|
| **distinct assertions written** | **5,433** |
| **assertions executed per full gate run** | **21,527** |
...
**Quote 5,433 for "how many tests exist" and 21,527 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 86 entrypoints, 21,527 assertions, 0 failures |
...
limit on what §2's 21,527 executed assertions certify: they establish that the system behaves as
