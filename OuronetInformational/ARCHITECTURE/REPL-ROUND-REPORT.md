...
| | |
|---|---:|
| **distinct assertions written** | **5,429** |
| **assertions executed per full gate run** | **21,523** |
...
**Quote 5,429 for "how many tests exist" and 21,523 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 86 entrypoints, 21,523 assertions, 0 failures |
...
limit on what §2's 21,523 executed assertions certify: they establish that the system behaves as
