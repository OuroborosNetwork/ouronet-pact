...
|---|---|---|
| `REPL_SUITE_STATS.md` | every scale and coverage figure, plus all 5,445 per-function rows | **generated**: `cd REPL && python3 tools/_suite_stats.py --gate` |
...
| | |
|---|---:|
| **distinct assertions written** | **5,425** |
| **assertions executed per full gate run** | **21,519** |
...
**Quote 5,425 for "how many tests exist" and 21,519 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 86 entrypoints, 21,519 assertions, 0 failures |
...
limit on what §2's 21,519 executed assertions certify: they establish that the system behaves as
