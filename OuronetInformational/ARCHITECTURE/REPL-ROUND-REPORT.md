...
|---|---|---|
| `REPL_SUITE_STATS.md` | every scale and coverage figure, plus all 5,458 per-function rows | **generated**: `cd REPL && python3 tools/_suite_stats.py --gate` |
...
| | |
|---|---:|
| **distinct assertions written** | **5,458** |
| **assertions executed per full gate run** | **21,579** |
...
**Quote 5,458 for "how many tests exist" and 21,579 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 87 entrypoints, 21,579 assertions, 0 failures |
...
limit on what §2's 21,579 executed assertions certify: they establish that the system behaves as
