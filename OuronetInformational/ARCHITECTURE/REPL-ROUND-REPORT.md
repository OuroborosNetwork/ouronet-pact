...
|---|---|---|
| `REPL_SUITE_STATS.md` | every scale and coverage figure, plus all 5,470 per-function rows | **generated**: `cd REPL && python3 tools/_suite_stats.py --gate` |
...
| | |
|---|---:|
| **distinct assertions written** | **5,470** |
| **assertions executed per full gate run** | **21,698** |
...
**Quote 5,470 for "how many tests exist" and 21,698 for "how much ran".** They differ ~4x because
...
| | |
|---|---|
| gate | **GREEN** — 87 entrypoints, 21,698 assertions, 0 failures |
...
limit on what §2's 21,698 executed assertions certify: they establish that the system behaves as
