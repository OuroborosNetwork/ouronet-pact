...
Adding GS-13's two pins moved the assertion count 21,519 → 21,577, so `REPL_SUITE_STATS.md` had to be
...
counts toward the 21,577, it shows in the `+` column, and it never goes red. I wrote one myself this
...
> 2. Reverting **all six** and re-running the **whole gate**: **GREEN, 21,577 assertions, 0
