...
Read first:
- **`OuronetInformational/ouronet/architecture/DEPLOY_IMPACT_PATTERN.md`**
- **`OuronetInformational/ouronet/architecture/INTERFACE_VERSIONING.md`**
...
See **`OuronetInformational/modules/stage01/codex-repl.md`**.
