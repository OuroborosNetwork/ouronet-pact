...
(interface DeployerReadsV7
    ...
    (defun URC_0006b_DirectSwap:decimal (account:string swpair:string input-ids:[string] input-amounts:[decimal] output-id:string))
    (defun URC_0007b_InverseSwap:decimal (account:string swpair:string output-id:string output-amount:decimal input-id:string))
    ...
    ;;
    ;; DPDC / account / StoicPay UI reads (V7)
